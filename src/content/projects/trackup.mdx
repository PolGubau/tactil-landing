...
available: true
summary: { 
  en: "TrackUp is a smart workout app that personalizes your training in real time, adjusting routines to match your fitness level and progress. It simplifies the path to your goals with dynamic, data-driven workouts tailored just for you.", 
  es: "TrackUp es una aplicación de entrenamiento inteligente que personaliza tu entrenamiento en tiempo real, ajustando las rutinas para que coincidan con tu nivel de condición física y progreso. Simplifica el camino hacia tus objetivos con entrenamientos dinámicos y basados en datos, diseñados solo para ti."
  }
...
import trackup1 from './img/trackup/1.webp';
import trackup2 from './img/trackup/2.webp';
import trackup3 from './img/trackup/3.webp';
