...
summary: { 
  en: "React Beauty Flags is a handcrafted React library with 250+ flags for countries, regions, cities and symbols. It offers easy integration and customization for modern apps. The project includes a searchable showcase, interactive flag details, and automated scripts to keep designs updated from Figma, ensuring a fresh DX.", 
  es: "React Beauty Flags es una biblioteca de React con más de 250 banderas hechas a mano para países, regiones, ciudades y símbolos. Ofrece una integración fácil y personalización para aplicaciones modernas. El proyecto incluye una landing interactiva con el set de banderas  de las banderas y scripts automatizados para mantener los diseños actualizados desde Figma, asegurando una experiencia de desarrollo fresca." 
  }
...
import flagsOg from "./img/flags/og.webp"
import Q3 from "./img/flags/q3.webp"
import Q2 from "./img/flags/q2.webp"
import Q1 from "./img/flags/q1.webp"
import flags1 from "./img/flags/1.webp"
